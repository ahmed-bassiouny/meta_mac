package com.ntam.tech.thefutureisnow.activity;
...
import com.ntam.tech.thefutureisnow.adapter.AgendaDayAdapter;
import com.ntam.tech.thefutureisnow.adapter.SessionAgendaAdapter;
import com.ntam.tech.thefutureisnow.adapter.SessionMyAgendaAdapter;
import com.ntam.tech.thefutureisnow.api.utils.RetrofitRequest;
import com.ntam.tech.thefutureisnow.api.utils.RetrofitResponse;
import com.ntam.tech.thefutureisnow.interfaces.OnClickListenerAdapter;
import com.ntam.tech.thefutureisnow.model.Agenda;
import com.ntam.tech.thefutureisnow.model.Session;
...
public class AgendaActivity extends AppCompatActivity implements OnClickListenerAdapter {
    ...
    private void loadAgenda() {
        showData(false);
        RetrofitRequest.getAllAgenda(SharedPref.getMyAccount(this).getUserId(), new RetrofitResponse<List<com.ntam.tech.thefutureisnow.model.Agenda>>() {
            @Override
